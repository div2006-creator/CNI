...
export const CytoscapeGraph: React.FC<CytoscapeGraphProps> = ({
  ...
  useEffect(() => {
    ...
    const cy = cytoscape({
      ...
      style: [
        ...
        // Entity Type Colors
        { selector: 'node[type = "PERSON"]', style: { 'background-color': '#2457a6' } },
  ...
  return (
    <div className="relative w-full h-full min-h-0 rounded-xl bg-dark-950 border border-slate-800 overflow-hidden flex flex-col">
      {/* Top Toolbar */}
      ...
      <div ref={containerRef} style={{ height }} className="w-full flex-1 min-h-0 bg-dark-950" />
