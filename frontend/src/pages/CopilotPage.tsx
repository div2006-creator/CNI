              ...
              <Card key={i} className="border-saffron-300 bg-[#fcfcf9] shadow-md">
                <div className="space-y-5 font-sans">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-[#e5dfd3] text-xs font-mono">
                    <span className="text-stone-600">Supporting Evidence Citations: <strong className="text-emerald-700 font-bold">{res.supporting_evidence_ids.length > 0 ? res.supporting_evidence_ids.join(', ') : 'None'}</strong></span>
