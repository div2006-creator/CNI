    ...
    <div className="space-y-8 font-sans">
      ...
      <div className="p-4 bg-dark-900/90 border border-slate-800/80 rounded-2xl flex flex-wrap items-center justify-between gap-3 text-xs md:text-sm shadow-md">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => setShowAddRecord(true)} className="flex items-center gap-1.5 rounded-lg bg-intel-cyan px-3 py-2 text-xs font-bold text-white shadow-sm hover:bg-intel-blue">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <Card className="p-1">
          <div className="p-4 flex items-center justify-between">
            ...
            <div className="p-3 bg-cyan-50 border border-cyan-200 rounded-xl text-cyan-700 shadow-sm">
        ...
        <Card className="p-1">
          <div className="p-4 flex items-center justify-between">
            ...
            <div className="p-3 bg-purple-50 border border-purple-200 rounded-xl text-purple-700 shadow-sm">
        ...
        <Card className="p-1">
          <div className="p-4 flex items-center justify-between">
            ...
            <div className="p-3 bg-indigo-50 border border-indigo-200 rounded-xl text-intel-blue shadow-sm">
        ...
        <Card className="p-1">
          <div className="p-4 flex items-center justify-between">
            ...
            <div className="p-3 bg-rose-50 border border-rose-200 rounded-xl text-rose-600 shadow-sm">
