...
const t_minus_10d = new Date(Date.now() - 10 * 86400000).toISOString();
const t_minus_30d = new Date(Date.now() - 30 * 86400000).toISOString();
...
export const MOCK_ENTITIES: Entity[] = [
  {
    ...
    risk_level: 'CRITICAL',
    risk_score: 0.92,
    attributes: { known_aliases: ['Alpha', 'Broker'], status: 'Primary Target' },
...
export const MOCK_RELATIONSHIPS: Relationship[] = [
  { id: 'rel-01', source_id: 'person-101', target_id: 'person-102', type: 'KNOWS', confidence: 0.95, weight: 1.0, attributes: { relationship_age: '3 years' }, start_time: t_minus_30d, timestamp: t_minus_30d, source_type: 'SURVEILLANCE_REPORT', evidence_id: 'ev-001', source_name: 'Subject Alpha', target_name: 'Subject Bravo' },
  { id: 'rel-02', source_id: 'person-101', target_id: 'org-201', type: 'OWNS', confidence: 0.98, weight: 1.0, attributes: { beneficial_ownership: '100%' }, start_time: t_minus_30d, timestamp: t_minus_30d, source_type: 'CORPORATE_FILING', evidence_id: 'ev-002', source_name: 'Subject Alpha', target_name: 'Vortex Trading Corp' },
  { id: 'rel-03', source_id: 'person-104', target_id: 'org-201', type: 'WORKS_FOR', confidence: 0.90, weight: 0.8, attributes: { title: 'Chief Financial Admin' }, start_time: t_minus_30d, timestamp: t_minus_30d, source_type: 'CORPORATE_FILING', evidence_id: 'ev-002', source_name: 'Subject Delta', target_name: 'Vortex Trading Corp' },
  { id: 'rel-04', source_id: 'org-201', target_id: 'account-301', type: 'OWNS', confidence: 1.0, weight: 1.0, attributes: {}, start_time: t_minus_30d, timestamp: t_minus_30d, source_type: 'BANK_WIRE', evidence_id: 'ev-003', source_name: 'Vortex Trading Corp', target_name: 'Bank Account #SYN-994021' },
  { id: 'rel-05', source_id: 'account-301', target_id: 'account-302', type: 'TRANSFERRED_TO', confidence: 0.99, weight: 0.95, attributes: { amount: '$500,000' }, start_time: t_minus_10d, end_time: t_minus_10d, timestamp: t_minus_10d, source_type: 'BANK_WIRE', evidence_id: 'ev-003', source_name: 'Bank Account #SYN-994021', target_name: 'Crypto Wallet 0x7a8F' },
  { id: 'rel-06', source_id: 'person-101', target_id: 'phone-401', type: 'USES', confidence: 0.85, weight: 0.9, attributes: {}, start_time: t_minus_30d, timestamp: t_minus_30d, source_type: 'CDR', evidence_id: 'ev-004', source_name: 'Subject Alpha', target_name: 'Burner #1' },
  { id: 'rel-07', source_id: 'phone-401', target_id: 'phone-402', type: 'CALLS', confidence: 0.92, weight: 0.85, attributes: { call_count_30d: 47 }, start_time: t_minus_10d, timestamp: t_minus_10d, source_type: 'CDR', evidence_id: 'ev-004', source_name: 'Burner #1', target_name: 'Burner #2' },
  { id: 'rel-08', source_id: 'person-102', target_id: 'phone-402', type: 'USES', confidence: 0.88, weight: 0.9, attributes: {}, start_time: t_minus_30d, timestamp: t_minus_30d, source_type: 'CDR', evidence_id: 'ev-004', source_name: 'Subject Bravo', target_name: 'Burner #2' },
  { id: 'rel-09', source_id: 'person-102', target_id: 'org-202', type: 'WORKS_FOR', confidence: 0.82, weight: 0.7, attributes: {}, start_time: t_minus_30d, timestamp: t_minus_30d, source_type: 'CORPORATE_FILING', evidence_id: 'ev-002', source_name: 'Subject Bravo', target_name: 'Apex Cargo Solutions' },
  { id: 'rel-10', source_id: 'person-103', target_id: 'person-102', type: 'ASSOCIATED_WITH', confidence: 0.75, weight: 0.6, attributes: {}, start_time: t_minus_10d, timestamp: t_minus_10d, source_type: 'SURVEILLANCE_REPORT', evidence_id: 'ev-001', source_name: 'Subject Charlie', target_name: 'Subject Bravo' },
  { id: 'rel-11', source_id: 'person-103', target_id: 'loc-501', type: 'VISITED', confidence: 0.80, weight: 0.7, attributes: { frequency: 'Weekly' }, start_time: t_minus_10d, timestamp: t_minus_10d, source_type: 'SURVEILLANCE_REPORT', evidence_id: 'ev-001', source_name: 'Subject Charlie', target_name: 'Warehouse Hub 7' },
  { id: 'rel-12', source_id: 'person-102', target_id: 'loc-501', type: 'LOCATED_AT', confidence: 0.78, weight: 0.7, attributes: { co_location_events: 5 }, start_time: t_minus_10d, timestamp: t_minus_10d, source_type: 'SURVEILLANCE_REPORT', evidence_id: 'ev-001', source_name: 'Subject Bravo', target_name: 'Warehouse Hub 7' },
  { id: 'rel-13', source_id: 'person-101', target_id: 'doc-801', type: 'MENTIONED_IN', confidence: 0.95, weight: 0.9, attributes: {}, start_time: t_minus_30d, timestamp: t_minus_30d, source_type: 'CORPORATE_FILING', evidence_id: 'ev-002', source_name: 'Subject Alpha', target_name: 'Offshore Incorporation Charter' }
];
...
export const MOCK_EVIDENCE: EvidenceItem[] = [
  ...
  },
  {
    ...
    linked_entity_ids: ['org-201', 'account-301', 'account-302'],
...
export const MOCK_GRAPH_DATA: NetworkGraphData = {
  nodes: MOCK_ENTITIES.map(e => ({
    ...
    is_bridge_node: e.is_bridge_node
  })),
  ...
  total_edges: MOCK_RELATIONSHIPS.length,
};
