...
def test_network_analytics_engine():
    graph_driver.upsert_node({"id": "node-1", "name": "Node 1", "type": "PERSON", "risk_score": 0.8, "risk_level": "HIGH"})
    graph_driver.upsert_node({"id": "node-2", "name": "Node 2", "type": "ORGANIZATION", "risk_score": 0.9, "risk_level": "CRITICAL", "is_bridge_node": True})
    graph_driver.upsert_edge({"id": "rel-1-2", "source_id": "node-1", "target_id": "node-2", "type": "ASSOCIATED_WITH"})
